...
- [ ] test.yml exists
- [ ] lint.yml exists
- [ ] sanitisers.yml exists
- [ ] determinism.yml exists
- [ ] format-version.yml exists
- [ ] nightly.yml exists
- [ ] CI is green on required platforms for current scaffold
- [ ] Determinism workflow is present and ready for activation as Stage 2 lands
